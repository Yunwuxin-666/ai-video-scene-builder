...
Use this contract whenever two or more film skills participate.
...
- Read FilmSpec; do not reinterpret the whole brief.
- Change only owned fields.
- Return a compact patch keyed by stable shot/entity IDs.
