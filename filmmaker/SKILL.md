---
name: filmmaker
description: Apply Disney's 12 animation principles to character performance, narrative animation, and animated cinematic staging. Use when the user explicitly asks for filmmaker, animation performance, animated storytelling, or the 12 principles in a film/animation scene. Do not use as a generic film-planning, live-action directing, storyboard, or AI-video prompt skill.
---
...
Use this skill only for animation-performance reasoning through the 12 principles. Do not invoke it as a general quality enhancer in `film-prompt-producer`, and do not let it rewrite FilmSpec, camera, lighting, style, VFX, sound, or platform prompts.
