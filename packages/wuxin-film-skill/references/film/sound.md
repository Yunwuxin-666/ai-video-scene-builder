...
- For concrete scene presets, read the same-directory `sound-scene-patterns.md`.
- For copy-ready output formats and prompt templates, read the same-directory `sound-prompt-templates.md`.
