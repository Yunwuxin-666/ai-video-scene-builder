...
- For lighting types, direction, quality, contrast, color temperature, and classic setups, read the same-directory `lighting-language.md`.
- For scene-specific lighting decisions, read the same-directory `lighting-scene-rules.md`.
- For uploaded image or generated-frame lighting diagnosis, read the same-directory `lighting-image-diagnosis.md`.
- For copy-ready prompt formats and reusable phrasing, read the same-directory `lighting-prompt-templates.md`.
