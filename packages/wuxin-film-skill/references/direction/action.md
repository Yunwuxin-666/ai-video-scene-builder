...
- For action category selection and 50 action classes, read the same-directory `action-types-50.md`.
- For rhythm words, camera impact, output format, and negative prompts, read the same-directory `action-rhythm-camera-prompts.md`.
