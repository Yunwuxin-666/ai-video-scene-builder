...
description: Set team-level animation motion language, review standards, and consistency using the 12 animation principles. Use when the user explicitly asks for animation creative direction, motion-language leadership, animator review standards, or cross-artist animation consistency. Do not use for general film creative direction, storyboards, commercials, or AI-video prompts.
---
...
Use this skill for animation-team leadership and motion-language review only. Do not invoke it as a generic film director inside `film-prompt-producer`, and do not let it rewrite FilmSpec or any production-department field.
